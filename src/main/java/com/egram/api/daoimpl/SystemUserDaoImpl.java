...
public class SystemUserDaoImpl implements SystemUserDao {
    ...
    public void saveRole(RoleEntity role) {
        ...
        try (var session = factory.openSession()) {
            ...
            log.error("Exception occurred during save role = {}", e.getMessage());
            throw new SomethingWentWrongException("Something went wrong during save role");
        }
    }
    ...
    public void save(SystemUserEntity user) {
        ...
        try (var session = factory.openSession()) {
            ...
            log.error("Exception occurred during save system user = {}", e.getMessage());
            throw new SomethingWentWrongException("Something went wrong during save system user");
        }
    }
}
